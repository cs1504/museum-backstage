...
//            $this->dbconfig = config('database');
    ...
    public function fileList()
    {
        ...
        uasort($list, function($a, $b)
        {
            ...
            return ($a['time'] < $b['time']) ? 1 : -1;   //倒序的话a<b返回大于0，正序a<b返回小于0
        });
        return $list;
    }
    ...
    public function Backup_Init()
    {
        ...
        $sql .= "CREATE DATABASE IF NOT EXISTS `museumtest` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;\n";
        $sql .= "USE `museumtest`;\n\n\n";
    ...
    public function backupDatabase() {
        self::Backup_Init();
        $tables = self::dataList();

        foreach ($tables as $table) {
            self::backup($table['name'], 0);
        }
        return ['valid' => 1, 'filename' => $this->file['name'], 'msg' => '备份成功'];
    }
